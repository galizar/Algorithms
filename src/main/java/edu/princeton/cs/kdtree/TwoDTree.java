...
public class TwoDTree {
    ...
    public Point2D nearest(Point2D p)
    {
        ...
        nearestPoint = nearest(root, new Node(p), nearestPoint, minDist);

        return nearestPoint;
    }

    private Point2D nearest(Node x, Node h, Point2D nearest, double minDist)
    {
        ...
        if (x.left != null && x.right != null)  {
            ...
            if (isLeftCloser && isRightCloser) {
                if (x.left.rectangle.contains(h.point)) {
                    nearest = nearest(x.left, h, nearest, minDist);
                } else {
                    nearest = nearest(x.right, h, nearest, minDist);
                }
     ...
     * @return {@code true} if this 2DTree contains {@code point} and {@code false}
     * otherwise
    ...
    public static void main(String[] args)
    {
        ...
        Point2D[] testPoints = {tp1, tp2, tp3, tp4, tp5};
        ...
        // System.out.println(tp3.distanceTo(tp1));
        // System.out.println(tp3.distanceTo(tp2));
        //
        // System.out.println(test2DT.nearest(tp3).toString());
        // System.out.println(test2DT.size());
